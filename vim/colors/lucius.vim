...
"
" I changed the guibg and ctermbg for bracket matching. 
" To make it the way it was, set them both to 'none'
"
hi MatchParen       guifg=#00ff00           guibg=#af8787              gui=bold
hi MatchParen       ctermfg=46              ctermbg=144            cterm=bold
